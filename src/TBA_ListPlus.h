...
public:
    ...
    void display()
    {
        ...
        while (cur) /* if head is NULL, the while loop will not be entered */
        {
            Serial.print  (F(" <"));
            ...
            Serial.print(F(" &cur: '"));
            Serial.print((unsigned int)cur, HEX);
            Serial.print(F("' &next: '"));
            Serial.print((unsigned int)(cur->next), HEX);
            Serial.print(F("' "));

            element.debugSerial("display");
